...
//TODO set "blockContainer as inUse = true when moving"
//TODO spawn new numbers after every move
...
function setRandomBlockPosition(newNumberblock) {
    ...
    if (availPos.length > 0) {
        //if its not in use it sets x and y to the cntainer block
